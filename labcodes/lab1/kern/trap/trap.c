...
static const char *IA32flags[] = { "CF", NULL, "PF", NULL, "AF", NULL, "ZF",
		"SF", "TF", "IF", "DF", "OF", NULL, NULL, "NT", NULL, "RF", "VM", "AC",
		"VIF", "VIP", "ID", NULL, NULL, };
...
void print_trapframe(struct trapframe *tf) {
	...
	int i, j;
	for (i = 0, j = 1; i < sizeof(IA32flags) / sizeof(IA32flags[0]); i++, j <<=
			1) {
